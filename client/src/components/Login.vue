<template>
  <span class="navbar-text">
    <button class="btn selectable text-light fw-5 lighten-30 text-uppercase my-2 my-lg-0" @click="login"
      v-if="!user.isAuthenticated">
      Login
    </button>
    <div v-else>
      <div class="dropdown my-2 my-lg-0">
        <div type="button" class="border-0 no-select mt-3" data-bs-toggle="dropdown" aria-expanded="false">
